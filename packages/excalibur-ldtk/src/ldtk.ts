...
export type TileLayerDefinition = LayerDefinition & { type: 'Tiles' };
...
export type TilesetDefinitionWithPath = TilesetDefinition & { relPath: string };
/**
...
export interface Level {
   ...
   */
  bgPos?: LevelBackgroundPosition | null;
  /**
...
export class Convert {
  public static toLDtk(json: string): LDtkProject {
    return cast(JSON.parse(json), r('LDtk'));
  }

  public static lDtkToJson(value: LDtkProject): string {
...
const typeMap: any = {
  ...
  ForcedRefs: o(
    [
      ...
      },
      {
        ...
        typ: u(undefined, r('FieldInstanceEntityReference')),
      },
      {
        json: 'EnumDef',
        js: 'enumDef',
      ...
      },
      {
        json: 'GridPoint',
        js: 'gridPoint',
        typ: u(undefined, r('FieldInstanceGridPoint')),
      },
      {
  ...
  FieldDefinition: o(
    [
      ...
      { json: 'type', js: 'fieldDefinitionType', typ: '' },
      { json: 'uid', js: 'uid', typ: 0 },
  ...
  LayerDefinition: o(
    [
      ...
      { json: 'type', js: 'layerDefinitionType', typ: r('Type') },
      { json: 'uid', js: 'uid', typ: 0 },
    ],
    false
  ),
  ...
  TilesetDefinition: o(
    [
      { json: '__cHei', js: 'cHei', typ: 0 },
      { json: '__cWid', js: 'cWid', typ: 0 },
      {
  ...
  EntityInstance: o(
    [
      { json: '__grid', js: 'grid', typ: a(0) },
      { json: '__identifier', js: 'identifier', typ: '' },
      { json: '__pivot', js: 'pivot', typ: a(3.14) },
      { json: '__smartColor', js: 'smartColor', typ: '' },
      { json: '__tags', js: 'tags', typ: a('') },
      {
        json: '__tile',
        js: 'tile',
        typ: u(undefined, u(r('TilesetRectangle'), null)),
  ...
  LayerInstance: o(
    [
      { json: '__cHei', js: 'cHei', typ: 0 },
      { json: '__cWid', js: 'cWid', typ: 0 },
      { json: '__gridSize', js: 'gridSize', typ: 0 },
      { json: '__identifier', js: 'identifier', typ: '' },
      { json: '__opacity', js: 'opacity', typ: 3.14 },
      { json: '__pxTotalOffsetX', js: 'pxTotalOffsetX', typ: 0 },
      { json: '__pxTotalOffsetY', js: 'pxTotalOffsetY', typ: 0 },
      {
  ...
  Level: o(
    [
      { json: '__bgColor', js: 'bgColor', typ: '' },
      {
        json: '__bgPos',
        js: 'bgPos',
        typ: u(undefined, u(r('LevelBackgroundPosition'), null)),
      },
      { json: '__neighbours', js: 'neighbours', typ: a(r('NeighbourLevel')) },
      { json: '__smartColor', js: 'smartColor', typ: '' },
      { json: 'bgColor', js: 'levelBgColor', typ: u(undefined, u(null, '')) },
      { json: 'bgPivotX', js: 'bgPivotX', typ: 3.14 },
      { json: 'bgPivotY', js: 'bgPivotY', typ: 3.14 },
      {
        json: 'bgPos',
        js: 'levelBgPos',
        typ: u(undefined, u(r('BgPos'), null)),
      },
